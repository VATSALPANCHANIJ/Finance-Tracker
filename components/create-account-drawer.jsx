                ...
                <div className='px-4 pb-4'>
                    <form className='space-y-4' onSubmit={handleSubmit(onSubmit)}>
                        <div className='space-y-2'>
                            ...
                            <Input id="name" placeholder="Add Account Name" {...register('name')} />
                            {errors.name && (
                        ...
                        <div className='flex gap-4 pt-4'>
                            <DrawerClose asChild>
                                <Button type="button" variant="outline" className="flex-1 mx-1">Cancel</Button>
                            </DrawerClose>
                            <Button type="submit" className="flex-1 mx-1" disabled={createAccountLoading}>
